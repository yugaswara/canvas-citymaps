...
$dimensions = woo_lokasi_image_dimensions( $woo_options['woo_layout'], $woo_options['woo_layout_width'] );
...
if ( $html != '' ) {
	echo '<div id="post-gallery" class="lokasi-img">' . woo_image( 'noheight=true&return=true&key=lokasi-image&width=520&class=lokasi-img' ) . '</div><!--/#post-gallery .lokasi-img-->' . "\n";
