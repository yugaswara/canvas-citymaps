...
<?php woo_post_inside_before();	?>
	...
	<header>
		<?php echo $title_before . apply_filters( 'woo_404_title', __( 'Error 404 - Halaman tidak ditemukan!', 'woothemes' ) ) . $title_after; ?>
	</header>

	<section class="entry">
	    <?php
	    	echo apply_filters( 'woo_404_content', __( 'Halaman yang anda cari tidak ditemukan atau sudah dihapus. Silakan kunjungi/cari halaman lainnya.', 'woothemes' ) );
