<?php
/**
 * Single Lokasi Item Template
 *
 * This template is the default lokasi item template. It is used to display content when someone is viewing a
 * singular view of a portfolio item ('lokasi' post_type).
...
<?php
	...
	if ( have_posts() ) { $count = 0;
		while ( have_posts() ) { the_post(); $count++;
			...
			locate_template( array( 'lokasi-gallery.php' ), true );
